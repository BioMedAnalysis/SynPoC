...
@utils.register_model(name='synpoc')
class SynPoC(nn.Module):
    """SynPoC model"""
    ...
    def __init__(self, config):
        ...
        modules.append(conv3x3(channels*3, nf))
    ...
    def forward(self, x, cond, time_cond, z):
        ...
        cond_feat = modules[m_idx](cond)
        m_idx += 1

      
        hs = [torch.cat((x_feat, cond_feat), axis=1)]
